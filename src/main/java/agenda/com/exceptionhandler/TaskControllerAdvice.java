...
public class TaskControllerAdvice {
    ...
    public ResponseEntity<MessageExceptionHandler> pessoanotfound(TaskNotFoundException taskNotFoundException){
        MessageExceptionHandler error = new MessageExceptionHandler(
                new Date(), HttpStatus.NOT_FOUND.value(),"Tarefa não encontrada");
